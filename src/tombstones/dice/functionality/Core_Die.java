package tombstones.dice.functionality;
...
public class Core_Die {
	 ...
	 */
	public final int range_max() {	return ((MAXIMUM_FACE_VALUE-MINIMUM_FACE_VALUE)+1); }
	public final int range_min() {	return MINIMUM_FACE_VALUE; }
